...
with_node \
  ...
  --target "/Users/soung/Project/jaejal2/ios/Pods/Target Support Files/Pods-jaejaljaejal/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake"
